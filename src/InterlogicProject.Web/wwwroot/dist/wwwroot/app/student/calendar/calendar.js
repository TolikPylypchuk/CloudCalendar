System.register(["@angular/core", "@angular/http", "@angular/platform-browser", "@ng-bootstrap/ng-bootstrap", "angular2-fullcalendar/src/calendar/calendar", "./calendar.component", "./modal-content.component", "./modal-comments.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, platform_browser_1, ng_bootstrap_1, calendar_1, calendar_component_1, modal_content_component_1, modal_comments_component_1, CalendarModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
